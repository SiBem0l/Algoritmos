...
// free
// Libera solo la memoria de una estructura (por ejemplo, del struct principal). 
// No siempre libera memoria interna (como nodos si es una first_nodea enlazada).
...
// destroy
// Libera toda la memoria asociada, incluyendo elementos internos como nodos, buffers, etc.
// A veces también reinicia valores o deja punteros en NULL.
...
Adicionales: top is_full. is_empty.
